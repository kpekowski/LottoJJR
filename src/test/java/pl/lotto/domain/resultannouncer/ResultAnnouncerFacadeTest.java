...
class ResultAnnouncerFacadeTest {
    ...
    public void it_should_return_response_with_lose_message_if_ticket_is_not_winning_ticket() {
        //given
        LocalDateTime drawDate = LocalDateTime.of(2023, 7, 29, 12, 0, 0);
        String hash = "123";
    ...
    public void it_should_return_response_with_wait_message_if_date_is_before_announcement_time() {
        //given
        LocalDateTime drawDate = LocalDateTime.of(2023, 8, 12, 12, 0, 0);
        String hash = "123";
        Clock clock = Clock.fixed(LocalDateTime.of(2023, 7, 29, 12, 0, 0).toInstant(ZoneOffset.UTC), ZoneId.systemDefault());
